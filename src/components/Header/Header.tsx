        ...
        <div className="header__content">
            ...
            <div className="header__menu-wrapper">
              ...
              <nav className="header__navigation">
                <ul className="header__navigation-list">
                  ...
                  <li className="header__navigation-item nav-text">Экстрим</li>
                  <li className="header__navigation-item nav-text">Легенды</li>
          ...
          <nav className="header__sport-navigation">
            <ul className="header__sport-navigation-list">
              ...
              <li className="header__sport-navigation-item usual-text">Бокс</li>
              <li className="header__sport-navigation-item usual-text">
                Легкая атлетика
              </li>
              <li className="header__sport-navigation-item usual-text">
